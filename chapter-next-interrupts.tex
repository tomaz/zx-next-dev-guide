...
With hardware IM2 mode it's possible to interrupt DMA operations. This is beyond the scope of this book, at least for the moment being. Here's what {\tt AA} wrote about this possibility on Next Discord server:
