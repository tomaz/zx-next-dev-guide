...
We as programmers need to tell hardware where in the memory tilemap and tile definitions are stored. \PortTextXRef{6E} and \PortTextXRef{6F} are used for that.
...
If single byte tilemap mode is selected (bit 5 of \PortTextXRef{6B} set), this register defines attributes for all tiles.
