...
The pixel index from tile definitions is compared before palette offset is applied to upper 4 bits, so there's always one index between {\tt 0} and {\tt 15} that works as transparent colour.
