...
Since core 3.1.2, zxnDMA is mapped to \PortTextXRef{xx0B}.
...
It's also possible to allow or prevent specific interrupters from interrupting DMA using Next specific Hardware IM2 mode. This is configured with Next registers \PortTextXRef{CC}, \PortTextXRef{CD} and \PortTextXRef{CE}. See section \XRef{zx_next_interrupts} for more details on interrupts.
