...
\newcommand{\zxsee}[1]{(see \ref{#1_registers})}
...
\begingroup
	...
	\begin{tabularx}{\textwidth}{lllX}
		...
		\zxport{RW}{243B}{0010 0100 0011 1011}{Selects active port for TBBlue/Next feature configuration (see \ref{TBBlue Register Select})}
		\zxport{RW}{253B}{0010 0101 0011 1011}{Reads and/or writes the selected TBBlue control register (see \ref{TBBlue Register Access})}
...
\begingroup
	...
	\begin{tbbluereg}
		...
		\nextport{RW}{6}{Enables CPU Speed key, DivMMC, Multiface, Mouse and AY audio \zxsee{zx_next_sound}}
		...
		\nextport{RW}{11}{Sets video output timing variant \zxsee{zx_next_dma}}
	...
	\begin{tbbluereg}
		...
		\nextport{-W}{60}{Used to upload code to the Copper \zxsee{zx_next_copper}}
		\nextport{RW}{61}{Holds low byte of Copper control bits \zxsee{zx_next_copper}}
		\nextport{RW}{62}{Holds high byte of Copper control flags \zxsee{zx_next_copper}}
		\nextport{-W}{63}{Used to upload code to the Copper in 16-bit chunks \zxsee{zx_next_copper}}
		...
		\nextport{RW}{69}{Layer2, ULA shadow, Timex \MemAddr{FF} port \zxsee{zx_next_layer2}}
		...
		\nextport{-W}{75}{Same as \PortLink{Sprite Port-Mirror Attribute 0}{35} plus increments \MemAddr{34} \zxsee{zx_next_sprites}}
		\nextport{-W}{76}{Same as \PortLink{Sprite Port-Mirror Attribute 1}{36} plus increments \MemAddr{34} \zxsee{zx_next_sprites}}
		\nextport{-W}{77}{Same as \PortLink{Sprite Port-Mirror Attribute 2}{37} plus increments \MemAddr{34} \zxsee{zx_next_sprites}}
		\nextport{-W}{78}{Same as \PortLink{Sprite Port-Mirror Attribute 3}{38} plus increments \MemAddr{34} \zxsee{zx_next_sprites}}
		\nextport{-W}{79}{Same as \PortLink{Sprite Port-Mirror Attribute 4}{39} plus increments \MemAddr{34} \zxsee{zx_next_sprites}}
	...
	\begin{tbbluereg}
		...
		\nextport{RW}{C0}{Interrupt Control \zxsee{zx_next_interrupts}}
		\nextport{RW}{C2}{NMI Return Address LSB \zxsee{zx_next_interrupts}}
		\nextport{RW}{C3}{NMI Return Address MSB \zxsee{zx_next_interrupts}}
		\nextport{RW}{C4}{Interrupt Enable 0 \zxsee{zx_next_interrupts}}
		\nextport{RW}{C5}{Interrupt Enable 1 \zxsee{zx_next_interrupts}}
		\nextport{RW}{C6}{Interrupt Enable 2 \zxsee{zx_next_interrupts}}
		\nextport{RW}{C8}{Interrupt Status 0 \zxsee{zx_next_interrupts}}
		\nextport{RW}{C9}{Interrupt Status 1 \zxsee{zx_next_interrupts}}
		\nextport{RW}{CA}{Interrupt Status 2 \zxsee{zx_next_interrupts}}
		\nextport{RW}{CC}{DMA Interrupt Enable 0 \zxsee{zx_next_interrupts}}
		\nextport{RW}{CD}{DMA Interrupt Enable 1 \zxsee{zx_next_interrupts}}
		\nextport{RW}{CE}{DMA Interrupt Enable 2 \zxsee{zx_next_interrupts}}
...
To write using full 16-bit address, {\tt OUT (C),r} instruction is used instead. Example of writing a byte to serial port using \PortNoLink{UART TX}{133B}:
