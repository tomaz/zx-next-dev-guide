...
\begingroup
	...
	\begin{tbbluereg}
		...
		\nextport{RW}{11}{Sets video output timing variant \zxsee{zx_next_dma_registers}}
	...
	\begin{tbbluereg}
		...
		\nextport{-W}{60}{Used to upload code to the Copper \zxsee{zx_next_copper_registers}}
		\nextport{RW}{61}{Holds low byte of Copper control bits \zxsee{zx_next_copper_registers}}
		\nextport{RW}{62}{Holds high byte of Copper control flags \zxsee{zx_next_copper_registers}}
		\nextport{-W}{63}{Used to upload code to the Copper in 16-bit chunks \zxsee{zx_next_copper_registers}}
