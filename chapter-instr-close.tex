...
IN A, (&FE)
	...
	\begin{DetailItem}{IND}
		...
		\begin{DetailEffects}
			\FlagsIND
			\DetailFlagsComments{
				\item {\tt SF}, {\tt HF} and {\tt PV} are destroyed on Next, for other Z80 computers see \XRef{z80_undocumented_instructions_io_block}
...
LDDR
	...
	\begin{DetailItem}{\small NEXTREG n,s{\scriptsize \ZXN}}
		...
		Directly sets the Next Feature Control Registers without going through ports \PortTextXRef{243B} and \PortTextXRef{253B}. See section \XRef{zx_next_tbblue_registers} for registers list.
